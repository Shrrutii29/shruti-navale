...
export default function HeroLanding() {
  ...
  return (
    <section className="min-h-screen bg-black flex items-center px-8">
      <div className="max-w-3xl">
        ...
        <p className="text-neutral-400 text-4xl md:text-5xl font-semibold leading-tight mt-1">
          {wrapChars("I build clean, meaningful", "tag1")}
          <br />
          {wrapChars("digital experiences", "tag2")}
        </p>

        <p className="text-neutral-400 text-4xl md:text-5xl font-semibold leading-tight mt-0.5">
